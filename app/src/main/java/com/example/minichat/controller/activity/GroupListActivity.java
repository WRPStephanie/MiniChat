...
import com.example.minichat.controller.adapter.GroupListAdapter;
    ...
    private void initListener() {
        ...
        lv_grouplist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // 群id
                EMGroup emGroup = EMClient.getInstance().groupManager().getAllGroups().get(position - 1);//头布局的position为0，故此处要-1
