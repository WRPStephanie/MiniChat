...
import com.example.minichat.controller.adapter.PickContactAdapter;
import com.example.minichat.model.Model;
import com.example.minichat.model.bean.PickContactInfo;
    ...
    private void initListener() {
        ...
        tv_pick_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("members", names.toArray(new String[0]));//key与启动页面一模一样
